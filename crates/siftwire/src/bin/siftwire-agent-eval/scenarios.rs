...
fn first_group() -> Vec<Scenario> {
    vec![
        ...
        entry(
            ...
            &[
                "Configure an RSS source for https://github.blog/feed/ with key github-blog, section technology, and threshold medium. Run a SiftWire brief, prepare delivery selecting the returned candidate, confirm after simulated transport, then run the brief again and report whether repeats were suppressed.",
            ],
        ),
    ]
}
