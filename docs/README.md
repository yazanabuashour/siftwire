...
- [Database-backed configuration](architecture/db-backed-configuration-adr.md):
  configuration, state, and migration boundaries

## Understand contracts

- [Runner contract](runner-contract.md): process framing, actions, compatibility,
  state, and retries
...
- [Contributing](../CONTRIBUTING.md): development checks and change expectations
